...
Alt::Alt(float x, float y,color_t color) {
    ...
    GLfloat c[]={
        ...
        228.0/255.0,183.0/255.0,229.0/255.0,
        69.0/255.0,78.0/255.0,158.0/255.0,
...
void Alt::draw(glm::mat4 VP,float x) {
